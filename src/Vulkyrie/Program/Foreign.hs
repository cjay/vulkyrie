...
mallocArrayRes :: Storable a => Int -> MetaResource (Ptr a)
mallocArrayRes n =
  metaResource
    Foreign.free
...
mallocRes :: Storable a => MetaResource (Ptr a)
mallocRes = metaResource Foreign.free Foreign.malloc
{-# INLINE mallocRes #-}

newArrayRes :: Storable a => [a] -> MetaResource (Ptr a)
newArrayRes xs =
  metaResource
    Foreign.free
    (Foreign.newArray xs)
